...
# Kandiyohi
MN_Kandiyohi <- train2 %>% filter(Province_State == "Minnesota") %>% filter(County == "Kandiyohi")
...
# Washington
MN_Washington <- train2 %>% filter(Province_State == "Minnesota") %>% filter(County == "Washington")
...
# Adams
CO_Adams <- train2 %>% filter(Province_State == "Colorado") %>% filter(County == "Adams")
tsAdamsCO <- ts(CO_Adams[, 6:7], start = c(2020, 23), frequency = 365)
autoplot(tsAdamsCO, main = "COVID-19 Cases and Deaths - Adams, CO")
# Arapahoe
CO_Arapahoe <- train2 %>% filter(Province_State == "Colorado") %>% filter(County == "Arapahoe")
...
# Boulder
CO_Boulder <- train2 %>% filter(Province_State == "Colorado") %>% filter(County == "Boulder")
...
# Denver
CO_Denver <- train2 %>% filter(Province_State == "Colorado") %>% filter(County == "Denver")
tsDenverCO <- ts(CO_Denver[, 6:7], start = c(2020, 23), frequency = 365)
autoplot(tsDenverCO, main = "COVID-19 Cases and Deaths - Denver, CO")
# Douglas
CO_Douglas <- train2 %>% filter(Province_State == "Colorado") %>% filter(County == "Douglas")
...
# El Paso
CO_ElPaso <- train2 %>% filter(Province_State == "Colorado") %>% filter(County == "El Paso")
tsElPasoCO <- ts(CO_ElPaso[, 6:7], start = c(2020, 23), frequency = 365)
autoplot(tsElPasoCO, main = "COVID-19 Cases and Deaths - El Paso, CO")
# Jefferson
CO_Jefferson <- train2 %>% filter(Province_State == "Colorado") %>% filter(County == "Jefferson")
...
# Weld
CO_Weld <- train2 %>% filter(Province_State == "Colorado") %>% filter(County == "Weld")
...
# Wayne
MI_Wayne <- train2 %>% filter(Province_State == "Michigan") %>% filter(County == "Wayne")
...
# Dakota
NE_Dakota <- train2 %>% filter(Province_State == "Nebraska") %>% filter(County == "Dakota")
tsDakotaNE <- ts(NE_Dakota[, 6:7], start = c(2020, 23), frequency = 365)
autoplot(tsDakotaNE, main = "COVID-19 Cases and Deaths - Dakota, NE")
# Douglas
NE_Douglas <- train2 %>% filter(Province_State == "Nebraska") %>% filter(County == "Douglas")
...
# Hall
NE_Hall <- train2 %>% filter(Province_State == "Nebraska") %>% filter(County == "Hall")
tsHallNE <- ts(NE_Hall[, 6:7], start = c(2020, 23), frequency = 365)
autoplot(tsHallNE, main = "COVID-19 Cases and Deaths - Hall, NE")
# Scotts Bluff
NE_Scotts <- train2 %>% filter(Province_State == "Nebraska") %>% filter(County == "Scotts Bluff")
...
# Bucks
PA_Bucks <- train2 %>% filter(Province_State == "Pennsylvania") %>% filter(County == "Bucks")
tsBucksPA <- ts(PA_Bucks[, 6:7], start = c(2020, 23), frequency = 365)
autoplot(tsBucksPA, main = "COVID-19 Cases and Deaths - Bucks, PA")
# Montgomery
PA_Montgomery <- train2 %>% filter(Province_State == "Pennsylvania") %>% filter(County == "Montgomery")
...
# Philadelphia
PA_Philadelphia <- train2 %>% filter(Province_State == "Pennsylvania") %>% filter(County == "Philadelphia")
...
# Brown
SD_Brown <- train2 %>% filter(Province_State == "South Dakota") %>% filter(County == "Brown")
tsBrownSD <- ts(SD_Brown[, 6:7], start = c(2020, 23), frequency = 365)
autoplot(tsBrownSD, main = "COVID-19 Cases and Deaths - Brown, SD")
# Minnehaha
SD_Minnehaha <- train2 %>% filter(Province_State == "South Dakota") %>% filter(County == "Minnehaha")
